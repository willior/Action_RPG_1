...
func _init():
	...
	GameManager.connect("player2_initialized", self, "_on_player_initialized")
# warning-ignore:return_value_discarded
	GameManager.connect("player2_reinitialized", self, "_on_player_initialized")
...
func update_formula_quantity(selected_formula):
	...
	var ingredients = get_node("/root/World/YSort/Player2").pouch.get_ingredients()

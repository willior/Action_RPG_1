...
const BossMusic = preload("res://assets/Audio/Hello_drone.ogg")
...
func examine():
	var dialog_script = [
		{'text': "I'm not sure how, or why - but I've found myself among the stars. There is only one logical step from here."},
		{'text': "A showdown."}
	]
